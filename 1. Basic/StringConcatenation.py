...
# 2. .join
# '+' good choice if concatenating only two strings. However if concatenating two or more strings, .join is a better choice.
for name in names:  
...
# 3. .format
# If we are concatenating our strings with different variables. This method could be a great choice.
rat = 'Tom'
cat = 'Jerry'
dog = 'Oggy'
