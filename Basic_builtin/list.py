...
#3. varname[a:b]
#Slicing methods
print(my_list[0:3])    #getting the first 3 elements
print(my_list[4:6])    #getting the 5th to 6th element
print(my_list[:3])     #getting the first 3 elements
print(my_list[-3:])    #getting the last 3 elements
print(my_list[:])      #getting all the elements
print('\n')
