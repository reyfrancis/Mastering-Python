...
# Read Image as Color
img_1 = cv2.imread('/home/rey/Desktop/Mastering-Python/OpenCV/Image Files/Rose.jpeg', cv2.IMREAD_COLOR)
# Display the Image
cv2.imshow('Flower_Color', img_1)



# Read Image as Grayscale
img_2 = cv2.imread('/home/rey/Desktop/Mastering-Python/OpenCV/Image Files/Flower.jpg', cv2.IMREAD_GRAYSCALE)
...
while(True):
    ...
    if k & 0xFF == 27:   # 27 stands for ESC character
        ...
        cv2.imwrite('/home/rey/Desktop/Mastering-Python/OpenCV/Image Files/Flower_Gray.jpg', img_2)
        break
